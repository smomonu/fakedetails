  ...
  const features = [
    {
      ...
      description: 'Generate thousands of realistic fake records in milliseconds with our optimized algorithms.'
    },
    {
      icon: Shield,
      title: 'Privacy & Security',
      description: 'All data is generated locally in your browser. No real personal information is ever used or stored.'
    },
    {
      icon: Globe,
      title: 'Multiple Formats',
      description: 'Export your data in JSON, CSV, XML, or SQL formats to fit any development workflow.'
    },
    {
      icon: Lock,
      title: 'GDPR Compliant',
      description: 'Fully compliant with privacy regulations since we only generate synthetic, non-personal data.'
    },
    {
      icon: Refresh,
      title: 'Bulk Operations',
      description: 'Generate up to 10,000 records at once with customizable field combinations and formats.'
    },
    {
      icon: Download,
      title: 'Easy Integration',
      description: 'RESTful API and SDK support for seamless integration into your existing development tools.'
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: 'Populate databases, test user interfaces, and validate application logic with realistic test data.',
      color: 'bg-blue-500'
    },
    {
      icon: TestTube2,
      title: 'Quality Assurance',
      description: 'Create comprehensive test scenarios and edge cases without compromising real user data.',
      color: 'bg-green-500'
    },
    {
      icon: Palette,
      title: 'Design & Prototyping',
      description: 'Fill mockups and prototypes with realistic content to demonstrate user experiences effectively.',
      color: 'bg-purple-500'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: 'This tool saved us weeks of development time. The quality of generated data is exceptional.',
      rating: 5
    },
    {
      name: 'Marcus Rodriguez',
      role: 'QA Lead at DataFlow',
      content: 'Finally, a fake data generator that understands the nuances of real-world data patterns.',
      rating: 5
    },
    {
      name: 'Emily Watson',
      role: 'Product Designer at DesignLab',
      content: 'Perfect for creating realistic prototypes. The variety of data types is impressive.',
      rating: 5
    }
  ];
  ...
  const pricingPlans = [
    {
      ...
      price: '$0',
      period: 'forever',
      features: ['100 records per day', 'Basic data types', 'JSON & CSV export', 'Community support'],
      popular: false,
    ...
    },
    {
      ...
      price: '$99',
      period: 'per month',
      features: ['Unlimited records', 'Custom data schemas', 'White-label solution', 'Dedicated support', 'SLA guarantee'],
      popular: false,
      color: 'border-gray-200'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#docs" className="text-gray-600 hover:text-purple-600 transition-colors">Docs</a>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100">
            <div className="px-4 py-2 space-y-1">
              ...
              <a href="#docs" className="block px-3 py-2 text-gray-600 hover:text-purple-600">Docs</a>
              <a href="#support" className="block px-3 py-2 text-gray-600 hover:text-purple-600">Support</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Power your development, testing, and design workflows with high-quality synthetic data. 
              Generate millions of realistic records across 50+ data types in seconds.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Generate any type of data you need for your projects, from personal information to complex business data.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From startups to enterprise teams, see how FakeGen Pro accelerates workflows across different disciplines.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See what our community has to say about FakeGen Pro
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Everything you need to know about FakeGen Pro
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
            Join thousands of developers who trust FakeGen Pro for their data generation needs. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-xl font-bold text-white">FakeGen Pro</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">
              © 2025 FakeGen Pro. All rights reserved.
            </p>
